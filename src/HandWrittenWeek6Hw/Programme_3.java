 ...
 * 3.6 Call both instance and static methods inside the Main method and run the programme.
 */
public class Programme_3 {
    ...
    //3.2 Declare one instance method.
    //3.4 Call both instance and static variable in to instance method in print statement.
    public void instanceMethod(){
        System.out.println(name);
        System.out.println(Programme_3.surname);
    }
    //3.3 Declare one static method.
    //3.4 Call both instance and static variable in to static method in print statement.
